  ...
  return (
    ...
    <main className="flex min-h-screen flex-col items-center justify-start  px-4 md:px-24 relative">
      ...
      <div className="mt-5 flex justify-center gap-x-4">
        <a href="/books" className="bg-[#0073fff2] text-white hover:bg-[#0073ffe3] transition duration-200 flex justify-center items-center px-5 py-2.5 rounded-xl font-bold text-base">Empezar a leer</a>
        <a href="https://github.com/francoogilli/bible" target="_blank" className="bg-zinc-900/70 hover:bg-zinc-800/70 transition duration-200 border border-zinc-800 text-zinc-100 flex justify-center items-center gap-x-2.5 px-5 py-2.5 rounded-xl font-semibold text-base"><GitHub />Star on GitHub</a>
      </div>
    </div>
    </main>
  );
