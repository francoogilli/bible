  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-start  px-4 md:px-24 relative">
      ...
      <div className="mt-5 flex justify-center gap-x-4">
        <a href="#" className="bg-[#FFD700] text-white hover:bg-[#ffd900dd] transition duration-200 flex justify-center items-center px-5 py-2.5 rounded-lg font-bold text-base">Empezar a leer</a>
