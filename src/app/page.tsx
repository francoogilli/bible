...
export default function Home() {
  return (
    ...
    <main className="flex min-h-screen flex-col items-center justify-start  px-4 md:px-24 relative">
        <div className="absolute top-0 z-[-2] h-screen w-full bg-[#1b1918] bg-[radial-gradient(ellipse_42%_68%_at_50%_-20%,rgba(216,195,135,0.3),rgba(255,255,255,0))] md:bg-[radial-gradient(ellipse_22%_70%_at_50%_-20%,rgba(216,195,135,0.3),rgba(255,255,255,0))]"></div>
      ...
      <div className="mt-5 flex justify-center gap-x-4">
          ...
          <a href="https://github.com/francoogilli/bible" target="_blank" className="bg-zinc-900/70 hover:bg-zinc-800/70 transition duration-200 border border-zinc-800 text-zinc-100 flex justify-center items-center gap-x-2.5 px-5 py-2.5 rounded-xl font-semibold text-base md:hidden"><GitHub />GitHub</a>
          <a href="https://github.com/francoogilli/bible" target="_blank" className="bg-zinc-900/70 hover:bg-zinc-800/70 transition duration-200 border border-zinc-800 text-zinc-100 justify-center items-center gap-x-2.5 px-5 py-2.5 rounded-xl font-semibold text-base hidden md:flex"><GitHub />Star on GitHub</a>
      </div>
    </div>
    </main>
  );
